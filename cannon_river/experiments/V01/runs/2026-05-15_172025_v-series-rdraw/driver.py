...
def _et_scale():
    """Return et_scale if present and active in params.yml, else None."""
    if 'et_scale' not in _param_cfg or not _param_cfg['et_scale']['active']:
        return None
    return get('et_scale')

def _et_alpha():
    """Return et_alpha if present and active in params.yml, else None."""
