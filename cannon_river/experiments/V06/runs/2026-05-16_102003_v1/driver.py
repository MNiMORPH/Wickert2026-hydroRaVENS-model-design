...
def _wp_soil_sigma():
    """Return wp_soil_sigma if active, else None (0.0 default = hard threshold)."""
    if 'wp_soil_sigma' not in _param_cfg or not _param_cfg['wp_soil_sigma']['active']:
        return None
    return get('wp_soil_sigma')
