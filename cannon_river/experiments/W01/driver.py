#!/usr/bin/env python3
"""
Dakota driver for hydroRaVENS calibration — W01 (shared recession exponent b, calibrated).
"""
...
def _recession_exponents():
    """Shared b for soil and karst; shallow stays linear."""
    b = get('recession_b')
    return [1.0, b, b]
...
try:
    result = run_and_score(
        ...
        recession_exponents_calibrated = 1,
        modules               =  MODULES,
